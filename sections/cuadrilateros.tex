...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot400}
...
\begin{figure}[!h]
    \centering
    \input{plots/cuadrilateros/plot401}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot402}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot403}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot404}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot405}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot406}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot407}
...
\begin{definition}[\textbf{Región polinomial}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot408}
...
\begin{definition}[\textbf{Área de una región polinomial}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot409}
...
\begin{postulate}[\textbf{Área de una región cuadrada}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot410}
        \caption{$a(ABCD) = l * l$}
...
\begin{theorem}[\textbf{Área de una región rectangular}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot411}
        \caption{$a(ABCD) = b * h$}
...
\begin{theorem}[\textbf{Área de una región determinada por un triángulo rectángulo}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot412}
...
\begin{theorem}[\textbf{Área de una región triangular}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot413}
        \caption{$a(ABC) = \dfrac{b * h}{2}$}
...
\begin{theorem}[\textbf{Teorema del área de una región determinada por un trapecio}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot414}
...
\begin{theorem}[\textbf{Teorema del área de una región determinada por un paralelogramo}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot415}
...
\begin{theorem}[\textbf{Área de una región determinada por un rombo}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/cuadrilateros/plot416}
