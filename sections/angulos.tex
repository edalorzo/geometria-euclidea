...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{.5\textwidth}
        \centering
        \input{plots/definitions/angle-interior}
...
\begin{figure}[!h]
    \centering
    \input{plots/definitions/angle-measure}
...
\begin{postulate}[\textbf{Construcción de ángulos:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/angle-const}
...
\begin{theorem}[\textbf{Teorema de la construcción de ángulos:}]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.3\textwidth}
            \centering
            \input{plots/basicos/plot34}
            \label{fig:postulado34}
        \end{subfigure}%
        \begin{subfigure}[b]{.3\textwidth}
            \centering
            \input{plots/basicos/plot35}
...
\begin{definition}[\textbf{Rayos opuestos:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/oposing-rays}
...
\begin{definition}[\textbf{Par lineal:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/linear-pair}
