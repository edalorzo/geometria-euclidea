...
\begin{definition}[\textbf{Conjunto convexo:}]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/definitions/convex}
            \label{fig:convexset}
            \caption{Convexo}            
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/definitions/notconvex}
...
\begin{definition}[\textbf{Arista:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/arista}
        \label{fig:arista}
    \end{figure}
