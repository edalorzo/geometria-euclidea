\begin{definition}[\textbf{Triángulo:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/triangle}
        \label{fig:triangle}
    \end{figure}
...
\begin{definition}[\textbf{Triángulos congruentes:}]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post36}
            \label{fig:triag-congruence-1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post37}
...
\begin{postulate}[\textbf{Congruencia l-a-l}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post23}
            \label{fig:congruence-sas1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post24}
...
\begin{postulate}[\textbf{Congruencia a-l-a}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post25}
            \label{fig:congruence-asa1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post26}
...
\begin{postulate}[\textbf{Congruencia l-l-l}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post27}
            \label{fig:congruence-lll1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post28}
...
\begin{postulate}[\textbf{Congruencia a-a-l}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post29}
            \label{fig:congruence-aal1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post30}
...
\begin{postulate}[\textbf{Congruencia hipotenusa-cateto h-c:}]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post31}
            \label{fig:congruence-hlc1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/postulates/post32}
...
\begin{definition}[\textbf{Bisectriz de un ángulo:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/angle-bisector}
