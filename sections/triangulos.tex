\begin{definition}[\textbf{Triángulo:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/triangulos/triangle}
        \caption{Triángulo}
        \label{fig:triangle}
    \end{figure}
...
\begin{definition}[\textbf{Triángulos congruentes:}]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot36}
            \label{fig:triag-congruence-1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot37}
...
\begin{postulate}[\textbf{Congruencia l-a-l}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot23}
            \label{fig:congruence-sas1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot24}
...
\begin{postulate}[\textbf{Congruencia a-l-a}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot25}
            \label{fig:congruence-asa1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot26}
...
\begin{postulate}[\textbf{Congruencia l-l-l}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot27}
            \label{fig:congruence-lll1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot28}
...
\begin{postulate}[\textbf{Congruencia a-a-l}:]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot29}
            \label{fig:congruence-aal1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot30}
...
\begin{postulate}[\textbf{Congruencia hipotenusa-cateto h-c:}]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot31}
            \label{fig:congruence-hlc1}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/triangulos/plot32}
...
\begin{theorem}[\textbf{Triángulo equilátero es equiángulo:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/triangulos/theorem4}
...
\begin{definition}[\textbf{Bisectriz de un ángulo:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/triangulos/angle-bisector}
