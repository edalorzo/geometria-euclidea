...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/semejanza/theorem21}
...
\begin{theorem}[\textbf{Teorema de Tales}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/semejanza/theorem22}
...
\begin{figure}[!h]
    \centering
    \input{plots/semejanza/paralela-media}
...
\begin{definition}[\textbf{Proyección de la altura sobre la hipotenusa en un triángulo rectángulo}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/semejanza/projection-hypothenuse-1}
...
\begin{theorem}[\textbf{Del cateto}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/semejanza/projection-hypothenuse-2}
