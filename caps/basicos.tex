...
\begin{postulate}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/basicos/plot6}
        \caption{Puntos no colineales y el plano}
        \label{fig:plot6}
    \end{figure}
\end{postulate}
...
\begin{postulate}
    Si se tiene un plano $\pi$, una recta $m$ en el plano y un segmento cuyos extremos están en los dos semiplanos que determina $m$ en $\pi$, entonces el segmento interseca a la recta.
    
    \begin{figure}[!h]
        \centering
        \input{plots/basicos/plot17}
...
\begin{definition}[\textbf{Conjunto convexo:}]
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/basicos/plot24}
            \label{fig:plot24}
            \caption{Convexo}            
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/basicos/plot25}
            \label{fig:plot25}
            \caption{No Convexo}            
        \end{subfigure}
