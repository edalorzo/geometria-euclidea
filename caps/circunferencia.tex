...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/plot700}
    \caption{$O|r$}
...
\begin{definition}[\textbf{Cuerda}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot701}
        \label{fig:cuerda}
    \end{figure}
...
\begin{definition}[\textbf{Diámetro}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot702}
        \label{fig:diametro}
    \end{figure}
...
\begin{definition}[\textbf{Secante de una circunferencia}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot703}
        \label{fig:secante}
    \end{figure}
...
\begin{definition}[\textbf{Ángulo central}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot704}
...
\begin{definition}[\textbf{Arco menor / mayor}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot705}
        \label{fig:arcos}
    \end{figure}
\end{definition}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/plot706}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/plot707}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/plot708}
...
\begin{definition}[\textbf{Tangente a la Circunferencia}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot709}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot710}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/plot711}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot712}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot713}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot714}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot715}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot716}
...
\begin{theorem}[\textbf{Potencia de un Punto}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot720}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot721}
...
Si dos cuerdas de una circunferencia se intersecan en su interior, entonces el producto de las medidas de los segmentos determinados en una cuerda es igual al producto de las medidas de los segmentos determinados en la otra cuerda.
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot722}
...
\begin{definition}[\textbf{Corona Circular}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/plot723}
        %\caption{}
