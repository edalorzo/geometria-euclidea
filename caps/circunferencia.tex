...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/circle}
    \caption{$O|r$}
    \label{fig:circle}
\end{figure}
...
\begin{definition}[\textbf{Cuerda}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/cord}
        \label{fig:cord}
    \end{figure}
...
\begin{definition}[\textbf{Diámetro}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/diameter}
        \label{fig:diameter}
    \end{figure}
...
\begin{definition}[\textbf{Secante de una circunferencia}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/secant}
        \label{fig:secant}
    \end{figure}
...
\begin{definition}[\textbf{Ángulo central}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/central-angle}
...
\begin{definition}[\textbf{Arco menor / mayor}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/arcs}
        \label{fig:arcs}
    \end{figure}
\end{definition}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/theorem24}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/theorem25}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/theorem26}
...
\begin{definition}[\textbf{Tangente a la Circunferencia}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/tangent}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem27}
        \label{fig:theorem27}
    \end{figure}
...
\begin{figure}[!h]
    \centering
    \input{plots/circunferencia/theorem28}
    \label{fig:theorem28}
\end{figure}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem29}
        \label{fig:theorem29}
    \end{figure}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem30}
        \label{fig:theorem30}
    \end{figure}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem31}
        \label{fig:theorem31}
    \end{figure}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem32}
        \label{fig:theorem32}
    \end{figure}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem34}
...
\begin{theorem}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.33\textwidth}
            \centering
            \input{plots/circunferencia/theorem36}
            \label{fig:theorem36}
            \caption{$m\angle{A}=\dfrac{m\widearc{BC}-m\widearc{DE}}{2}$}
        \end{subfigure}%
        \begin{subfigure}[b]{.33\textwidth}
            \centering
            \input{plots/circunferencia/theorem35}
            \label{fig:theorem35}
            \caption{$m\angle{A}=\dfrac{m\widearc{BDC}-m\widearc{BC}}{2}$}
        \end{subfigure}%
        \begin{subfigure}[b]{.33\textwidth}
            \centering
            \input{plots/circunferencia/theorem37}
            \label{fig:theorem37}
...
\begin{theorem}[\textbf{Potencia de un Punto}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem38}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem39}
...
Si dos cuerdas de una circunferencia se intersecan en su interior, entonces el producto de las medidas de los segmentos determinados en una cuerda es igual al producto de las medidas de los segmentos determinados en la otra cuerda.
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/theorem40}
...
\begin{definition}[\textbf{Corona Circular}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/circunferencia/circular-crown}
        %\caption{}
