...
\begin{theorem}[\textbf{Relación de ángulos internos y ángulos externos:}]
...
\begin{definition}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/rectas/plot505}
            \label{fig:transversal}
            \caption{Transversal}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/rectas/plot506}
...
\begin{definition}[\textbf{Puntos notables del triángulo}]
