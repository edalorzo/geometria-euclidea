...
\begin{definition}[\textbf{Mediatriz}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/bisector}
        \caption{Mediatriz}
        \label{fig:bisector}
    \end{figure}
...
Sea $\triangle{ABC}, \pt{E}$ y $\pt{D}$, puntos tales que $B-C-E$ y $A-C-D$. Los ángulos $\angle{CAB}$ y $\angle{ABC}$ se llaman \textit{ángulos internos no contiguos} de los exteriores $\angle{BCD}$ y $\angle{ACE}$
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/intext-angles}
...
La medida de un ángulo exterior de un triángulo es mayor que la medida de cada uno de sus ángulos internos no contiguos a dicho triángulo.
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/intext-diff}
...
\begin{definition}
    ...
    \begin{figure}[h!]
        ...
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/definitions/transversal}
            \label{fig:transversal}
            \caption{Transversal}
        \end{subfigure}%
        \begin{subfigure}[b]{.5\textwidth}
            \centering
            \input{plots/definitions/not-transversal}
...
\begin{definition}[\textbf{Ángulos alternos internos:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/alternos-internos}
...
\begin{definition}[\textbf{Ángulos correspondientes:}]
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/definitions/correspondientes}
...
\begin{theorem}
    ...
    \begin{figure}[!h]
        \centering
        \input{plots/theorems/theorem20}
...
\begin{figure}[!h]
    \centering
    \input{plots/theorems/theorem19}
...
\begin{figure}[!h]
    \centering
    \input{plots/theorems/theorem17}
...
\begin{figure}[!h]
    \centering
    \input{plots/theorems/theorem18}
